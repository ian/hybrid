...
# Use the CLI without installing (pnpm)
pnpm dlx @hybrd/cli hybrid keys
pnpm dlx @hybrd/cli hybrid dev
pnpm dlx @hybrd/cli hybrid build
pnpm dlx @hybrd/cli hybrid clean
pnpm dlx @hybrd/cli hybrid upgrade
pnpm dlx @hybrd/cli hybrid register
pnpm dlx @hybrd/cli hybrid revoke <inboxId>
pnpm dlx @hybrd/cli hybrid revoke:all
